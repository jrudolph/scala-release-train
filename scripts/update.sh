...
echo "Running at $(date) for 2.11 -> 2.12.0-M4" | tee -a $LOG
java -jar /tmp/release-train-main-assembly-0.1-SNAPSHOT.jar -q -l 2.11 -t 2.12.0-M4 | gist -f analysis.txt -u d0e20c4a20af44459de1 2>&1 | tee -a $LOG
