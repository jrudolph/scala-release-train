...
echo "Running at $(date) for 2.12 -> 2.13.0-M3" | tee -a $LOG
java -jar /tmp/release-train-main-assembly-0.1-SNAPSHOT.jar -q -l 2.12 -t 2.13.0-M2 | gist -f analysis.txt -u 1b054191c235469592f62c7c61cb657d 2>&1 | tee -a $LOG
